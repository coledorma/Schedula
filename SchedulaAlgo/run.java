...
public final class run{
	 ...
	 **/
		...
		Commitment c = new Commitment("LAX",201630,"TR 11:35-12:35");
		...
		System.out.println((t.get(1).getTimes()[0]).conflicts(t.get(0).getTimes()[0]));
		System.out.println((t.get(1).getTimes()[0]).difference(t.get(0).getTimes()[0])+"\n");
